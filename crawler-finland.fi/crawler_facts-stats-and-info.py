...
def get_html(url) :
    ...
    for i in soup.find_all('a', href=re.compile(r"https://finland.fi/facts-stats-and-info/.*")) :
        yield i.get('href')
...
def save_data(content_list) :
    with open('../finland.fi/facts-stats-and-info.json', 'a', encoding='utf-8') as f:
