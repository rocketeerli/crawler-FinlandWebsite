...
def get_html(url) :
    ...
    for i in soup.find_all('a', href=re.compile(r"https://finland.fi/arts-culture/.*")) :
...
def save_data(content_list) :
    with open('../finland.fi/culture.json', 'a', encoding='utf-8') as f:
...
def main() :
    ...
    url = 'https://finland.fi/category/arts-culture/'
    fun_call(url)
